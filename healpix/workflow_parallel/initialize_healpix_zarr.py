...
def initialize_zarr_store(manifest_path, zarr_path, nside, healpix_dim_name, mpas_spatial_dim_name, time_chunk_size, spatial_chunk_size):
    ...
    za_time.attrs.update(time_encoding) # Store encoding info
...
if __name__ == "__main__":
    ...
    parser.add_argument("--zarr_path", required=True, help="Path to the output Zarr store to be created.")
    # parser.add_argument("--nside", type=int, required=True, help="HEALPix nside parameter.")
    # parser.add_argument("--healpix_dim_name", required=True, help="Name for the HEALPix spatial dimension in Zarr.")
    # parser.add_argument("--mpas_spatial_dim_name", required=True, help="Name of the MPAS spatial dimension (e.g., nCells).")
    ...
    # parser.add_argument("--variables", nargs='+', required=True, help="List of variables to include.")
    # parser.add_argument("--mpas_time_dim", default="Time", help="Name of the time dimension in MPAS files.")
    # parser.add_argument("--mpas_vert_dim_name", default="nVertLevels", help="Name of the vertical dimension in MPAS files.")
    # Add --overwrite option if you want to allow overwriting an existing Zarr store
