...
FILE_PATTERN="DYAMOND_diag_1h.3.75km.2020-*.nc"
# Zarr store and manifest paths
# ZARR_OUTPUT_PARENT_DIR="/glade/campaign/cgd/cas/brianpm/hack25" # Use a new dir for new runs
ZARR_OUTPUT_PARENT_DIR="/glade/derecho/scratch/digital-earths-hackathon/mpas_DYAMOND3/1hr"
ZARR_STORE_NAME="DYAMOND3_diag_1hr_to_hp10.zarr"
ZARR_OUTPUT_PREFIX="DYAMOND3_diag_1hr"
ZARR_OUTPUT_PATH="${ZARR_OUTPUT_PARENT_DIR}/${ZARR_STORE_NAME}"
# MANIFEST_FILE="${ZARR_OUTPUT_PARENT_DIR}/dy2_hist_3h_manifest.csv"
MANIFEST_FILE="${ZARR_OUTPUT_PARENT_DIR}/dy3_diag_1hr_manifest.csv"
...
PROCESS_MEM="64GB" # VERY IMPORTANT: Monitor memory for regridding. Adjust!
