...
FILE_PATTERN="diag.3.75km.2020-*.nc"

# Zarr store and manifest paths
# ZARR_OUTPUT_PARENT_DIR="/glade/campaign/cgd/cas/brianpm/hack25" # Use a new dir for new runs
ZARR_OUTPUT_PARENT_DIR="/glade/derecho/scratch/digital-earths-hackathon/mpas_DYAMOND3/30min"
ZARR_STORE_NAME="DYAMOND3_diag_30min_to_hp10.zarr"
ZARR_OUTPUT_PREFIX="DYAMOND3_diag_30min"
ZARR_OUTPUT_PATH="${ZARR_OUTPUT_PARENT_DIR}/${ZARR_STORE_NAME}"
# MANIFEST_FILE="${ZARR_OUTPUT_PARENT_DIR}/dy2_hist_3h_manifest.csv"
MANIFEST_FILE="${ZARR_OUTPUT_PARENT_DIR}/dy3_diag_30min_manifest.csv"
