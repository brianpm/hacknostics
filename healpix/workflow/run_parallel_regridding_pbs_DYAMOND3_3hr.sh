...
# DYAMOND3 - "Diag" (3hr)
INPUT_DIR="/glade/campaign/mmm/wmr/skamaroc/NSC_2023/3.75km_simulation_output_old_transport"
FILE_PATTERN="DYAMOND_diag_3h.3.75km.2020-*.nc"
# Zarr store and manifest paths
# ZARR_OUTPUT_PARENT_DIR="/glade/campaign/cgd/cas/brianpm/hack25" # Use a new dir for new runs
ZARR_OUTPUT_PARENT_DIR="/glade/derecho/scratch/digital-earths-hackathon/mpas_DYAMOND3/3hr"
ZARR_STORE_NAME="DYAMOND3_hist_3hr_to_hp10.zarr"
ZARR_OUTPUT_PREFIX="DYAMOND3_diag_3hr"
ZARR_OUTPUT_PATH="${ZARR_OUTPUT_PARENT_DIR}/${ZARR_STORE_NAME}"
# MANIFEST_FILE="${ZARR_OUTPUT_PARENT_DIR}/dy2_hist_3h_manifest.csv"
MANIFEST_FILE="${ZARR_OUTPUT_PARENT_DIR}/dy3_diag_3hr_manifest.csv"
...
# "Time" for DYAMOND3 diag
# "Time" for DYAMOND3 history
...
PROCESS_MEM="128GB" # VERY IMPORTANT: Monitor memory for regridding. Adjust!
PROCESS_WALLTIME="01:30:00" # Per input file. Adjust based on file size and complexity.
