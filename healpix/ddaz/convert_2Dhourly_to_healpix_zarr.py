...
def main():
    ...
    datafils = sorted(dataloc.glob("EW_B2000_CAM7_15km_58L_2D_hourly.000*.nc")) 
    ...
    #datafils = sorted(dataloc.glob("EW_B2000_CAM7_15km_58L_3D_6hourly.0001-03-01.nc")) # note: 4.4GB per file
