...
python simpler_rechunker_v1.py \
    /glade/derecho/scratch/digital-earths-hackathon/mpas_DYAMOND1/15min/DYAMOND1_diag_15min_to_hp2.zarr \
    /glade/derecho/scratch/digital-earths-hackathon/mpas_DYAMOND1/15min/DYAMOND1_diag_PT15M_to_hp2.zarr \
    --time-chunk 384 \
    --cell-chunk 192 \
    --fix-time \
